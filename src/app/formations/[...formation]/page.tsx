...
export default function Page() {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-ac-gray w-full">
      ...
      {/* Formation Infos */}
      <div className="flex flex-col-reverse xm:flex-row justfiy-start xm:justify-between items-center xm:items-start bg-ac-gray -translate-y-5 z-30 rounded-t-3xl w-full py-10 px-36 gap-2">
        {/* Path + Description */}
        <div className="flex flex-col justify-start items-start gap-16">
          {/* Path */}
          <div className={ibmFont.className + " flex justify-start items-center gap-2"}>
        ...
        <div className="flex flex-col justify-start items-stretch gap-10 -translate-y-56">
          {/* Formation Card */}
          <div className="flex flex-col justify-start items-center w-full bg-white shadow-formation-card rounded-xl px-5 py-2.5 gap-2.5">
            ...
            <div className="flex flex-col justify-start items-center gap-4 px-12">
              <Image src={"/Formations/testing.png"} width={200} height={200} alt='testing' />
              <div className="w-[140%] h-px bg-[#888888]"></div>
              <div className="flex justify-center items-center bg-ac-bleu rounded-full py-4 px-8">
                <p className={ibmFont.className + " text-base font-bold text-white uppercase"}>Recevoir un devis</p>
              </div>
            </div>
          </div>

          {/* Billing */}
          <div className={montserratFont.className + " flex justify-between items-stretch w-full"}>
            ...
            <div className="w-0.5 bg-[#888888]"></div>
