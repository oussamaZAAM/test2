...
export default function Blog({ }: Props) {
    ...
    const { title, body, author, date } = blogsData[parseInt(blog_id) - 1];
    ...
    return (
        <div className="flex flex-col justify-start items-center w-full bg-ac-gray2">
            ...
            <div className={montserratFont.className + " w-[90%] flex flex-col xm:flex-row justify-start items-center xm:items-start rounded-md bg-white gap-16 py-8 px-2 fold:px-6 sm:px-12 md:px-20 xm:px-6 lg:px-12 xl:px-20 mx-2 fold:mx-6 sm:mx-12 md:mx-20 xm:mx-6 lg:mx-12 xl:mx-20 my-11"}>
                ...
                {/* Auteur Card */}
                <div className="flex flex-col justify-start items-center gap-6 px-2 fold:px-6 py-6 rounded-2xl bg-ac-gray mt-24">
                    <div className="flex justify-center items-center w-full relative -mt-24">
                        ...
                        <Image className='object-contain object-center w-32 xs:w-40 h-32 xs:h-40 rounded-full border-2 border-zinc-500 z-30' src={"/user.png"} width={160} height={160} alt='user' />
                    </div>
                    <div className="flex flex-col justify-start items-center gap-10">
                        <div className="flex flex-col justify-start items-center">
                            <p className="uppercase font-bold text-2xl text-black text-center">{author.name}</p>
                            <p className="font-semibold text-xl text-black text-center">{author.job}</p>
                        </div>
