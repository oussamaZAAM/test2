...
function bezierFunction2(t: number) {
    const P0 = { x: 6, y: 470 };
    const P1 = { x: 146, y: 790 };
    const P2 = { x: 160, y: 620 };
    const P3 = { x: 0, y: 934 };
...
function bezierFunction3(t: number) {
    const P0 = { x: 0, y: 934 };
    const P1 = { x: -145, y: 1084 };
    const P2 = { x: -140, y: 1254 };
    const P3 = { x: 5, y: 1396 };
...
export function getXfromY3(y: number, tolerance = 0.001) {
    let t = 0;
    let step = 1;
    let currentY = bezierFunction3(t).y;
    ...
    while (Math.abs(currentY - y) > tolerance && t <= 1) {
        ...
        step /= 2;
        currentY = bezierFunction3(t).y;
    }

    return bezierFunction3(t).x;
}